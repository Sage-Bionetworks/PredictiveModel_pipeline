myData_CCLE <- function(data.type = c("Mh","C","CMo","CMh","E","EMo","EMh","EC","ECMo","ECMh","MhL","CL","CMoL","CMhL","EL","EMoL","EMhL","ECL","ECMoL","ECMhL"),drug.type = c("ActArea","IC50","EC50")){
  ...
  myIC50<-function(){
    id_drugLayer <- "syn1445085" 
    layer_drug <- loadEntity(id_drugLayer)
    adf_drug <- layer_drug$objects$ccleIC50
    return(adf_drug)
  }
  myEC50<-function(){
    id_drugLayer <- "syn1445083" 
    layer_drug <- loadEntity(id_drugLayer)
    adf_drug <- layer_drug$objects$ccleEC50
    return(adf_drug)
  }
